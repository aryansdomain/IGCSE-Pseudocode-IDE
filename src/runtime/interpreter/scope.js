...
export function addProperties(scope) {
    if (!Object.prototype.hasOwnProperty.call(scope, 'decl'))  Object.defineProperty(scope, 'decl',  { value: new Set(),           enumerable: false }); // stores lower-case names
...
export function setType(scope, name, type) {
    scope.types[String(name).toLowerCase()] = String(type).toUpperCase();
}
