export function initSplitter({
    ...
    let ratio = load(STORAGE_KEY, initialRatio);       // amount of space A takes up, load from storage key
    ...
    function load(key, fallback) {   // load ratio from localStorage
        try {
            const rato = localStorage.getItem(key);
