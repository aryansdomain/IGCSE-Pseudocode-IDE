export function initThemeCtrl({
    ...
    function updateFiles() {
        ...
        // set css var
        if (lineNumColor) document.documentElement.style.setProperty('--line-num-color', lineNumColor);
    }
    ...
    if (savedTheme && themeInfo(savedTheme).ok) setTheme(savedTheme, true);
    else                                        setTheme(getTheme(), true);
